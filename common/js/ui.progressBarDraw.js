...
/** 
 * circle 로딩 바 생성
 * @constructor progressBarDraw
 * @param {String} element circle이 그려질 부모 id나 class
 */
progressBarDraw.Circle = function(element){
    this.name = "progressBarDraw.Circle";
 ...
 */
progressBarDraw.Linear = function(options){
    this.name = "progressBarDraw.Linear";
